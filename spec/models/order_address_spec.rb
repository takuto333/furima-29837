...
RSpec.describe OrderAddress, type: :model do
  ...
  describe '商品購入機能' do
    context '商品購入がうまくいくとき' do
      it 'token,postal_code,prefecture_id,municipality,address,building_name,phone_numberがあれば購入できる。' do
